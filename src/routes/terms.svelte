 ...
 * Company (referred to as either "the Company", "We", "Us" or "Our" in this
   Agreement) refers to Kaizen Labs Inc, 2045 W Grand Ave Ste B #50940
 ...
 * Website refers to Launcher, accessible from https://launcher.team
...
jordan@kaizenlabs.dev and include in Your notice a detailed description of the
...
You can contact our copyright agent via email at jordan@kaizenlabs.dev.
 ...
 * By email: jordan@kaizenlabs.dev
    `;
</script>
