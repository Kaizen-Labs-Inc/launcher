...
CREATE TABLE "backdrop_color" (
    ...
    CONSTRAINT "backdrop_color_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "_BackdropToBackdropColor" ADD FOREIGN KEY ("A") REFERENCES "backdrop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_BackdropToBackdropColor" ADD FOREIGN KEY ("B") REFERENCES "backdrop_color"("id") ON DELETE CASCADE ON UPDATE CASCADE;
